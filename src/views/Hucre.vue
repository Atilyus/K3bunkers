<template>
  <div class="hucre">
    ...
    <div v-if="dokum"  style="padding-top:5px">
     ...
     <hr>
      <div v-if="huco1" style="padding-top:5px">
        
        <input type="text" v-focus class="form-control" v-model="hucre" @input="hucoku(hucre)">
      </div>
      
        <div style="background-color:brown;padding-top:15px height: 33px;width:auto;max-width:300px;margin: auto;">
      <h2 style="color:aliceblue;width: auto;margin:auto" @click="hude()">Hücre1 : {{hucre}}</h2>
      </div>

      <hr>
      <div v-if="hhucre"  style="background-color:brown;height: 33px; width:auto;max-width:300px;margin: auto;">
       
       <h2 style="color:aliceblue;padding-top: 2px;width: auto;margin:auto" @click="hude2()">Hücre2 : {{hucre2}}</h2>
      </div>
      <div v-if="huco2" style="height:25px">
        <input style="padding-top:3px" type="text" v-focus class="form-control" v-model="hucre2" @input="hucoku2(hucre2)">
      </div>
...
export default {
  ...
  methods: {
    ...
    async Deptra(){
      if(this.hucre=="" || this.hucre==null || this.hucre1=="" || this.hucre1==null)
      {
      ...
      await axios({
      method: "get",
      url: this.netsisurl+"api/NetsApi/Huctra?id="+this.kampus+"&huc="+this.hucre,
    ...
    secilihat(id){
      this.dokum=true
      this.kampus=id
      this.title="Kampüs "+this.kampus+" Hücre Transfer"
      this.Getqu();
    },
    ksec(){
      this.dokum=false
